...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withPontos(int pontos) {
            ...
            if (pontos > 20) {
                throw new EstacionamentoException("Habilitação suspensa, pontuação superior a 20.");
            } else {
                this.pontos = pontos;
                return this;
            }
        ...
        public Motorista build() {
            ...
            if (habilitacao.equals(null)) {
                throw new NullPointerException("Habilitação não informada.");
            }
